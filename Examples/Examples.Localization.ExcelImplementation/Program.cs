...
namespace Examples.Localization.ExcelImplementation
{
    class Program
    {
        ...
        private static void Initialize()
        {
             ...
             *      "生成操作" 设置为 "无"
             */
            string xmlFilePath = @"Localizations\Localizations.xlsx";
            
            var dictionaryFactory = new ExcelLocalizationDictionaryFactory(xmlFilePath, null);
